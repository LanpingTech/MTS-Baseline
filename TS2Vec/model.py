...
class TS2Vec:
    ...
    def fit(self, train_data, n_epochs=None, n_iters=None, verbose=False, logger=None, val_data=None, val_label=None, cluster_cfg=None):
        ...
        while True:
            ...
            if verbose:
                ...
                logger("第{}Epoch的精度为：{}".format(self.n_epochs + 1, result))
