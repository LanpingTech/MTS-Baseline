...
def cluster_evaluation(y, y_pred):
    cluster_results = {}
    cluster_results['acc'] = cluster_acc(y, y_pred)
    cluster_results['pur'] = cluster_purity(y, y_pred)
    cluster_results['nmi'] = metrics.normalized_mutual_info_score(y, y_pred)
    cluster_results['ari'] = metrics.adjusted_rand_score(y, y_pred)
    return cluster_results

# Reference scikit-learn==0.19.2 sklearn.utils.linear_assignment_ import linear_assignment
